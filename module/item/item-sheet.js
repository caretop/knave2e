...
export class Knave2eItemSheet extends ItemSheet {
  ...
  //   if(item.category == "gear"){item.isWeapon = false; item.isInjury = false;}
  //   else if(item.category == "weapon"){
  //     this.object.update({"data.isWeapon" : true});
  //     this.object.update({"data.isInjury" : false});
  ...
  //     }
  //   }
  //   else if(item.category == "injury"){item.isWeapon = false; item.isInjury = true;}
